...
class Horario(models.Model):
    ...
    def __str__(self):
        return str(self.Hora_Inicio) + " - " + str(self.Hora_Final)
...
class DiaActividad(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Dias de Actividades"
        verbose_name = "Dia de Actividad"

    def __str__(self):
        return str(self.Dia_Actividad + "-" +  str(self.Horario))
